...
class dbORM:
    ...
    def insertMultipleApiCriptomoneda(self, api_ids, criptomoneda_ids):
        ...
        self.insertRelationship('insert_multiple_api_criptomoneda', api_ids=api_ids, criptomoneda_ids=criptomoneda_ids)

    def insertMultipleApiMercado(self, api_ids, mercado_ids):
        """Insertar múltiples relaciones entre API y mercados en la tabla 'api_mercados'."""
        self.insertRelationship('insert_multiple_api_mercados', api_ids=api_ids, mercado_ids=mercado_ids)

    def insertMultipleApiRegistro(self, api_ids, registro_ids):
        """Insertar múltiples relaciones entre API y registros en la tabla 'api_registros'."""
        self.insertRelationship('insert_multiple_api_registros', api_ids=api_ids, registro_ids=registro_ids)

    def insertMultipleApiMetricaGeneral(self, api_ids, metrica_ids):
        """Insertar múltiples relaciones entre API y métricas generales en la tabla 'api_metricas_generales'."""
        self.insertRelationship('insert_multiple_api_metricas_generales', api_ids=api_ids, metrica_ids=metrica_ids)

    def insertMultipleApiExchange(self, api_ids, exchange_ids):
        """Insertar múltiples relaciones entre API y exchanges en la tabla 'api_exchanges'."""
        self.insertRelationship('insert_multiple_api_exchanges', api_ids=api_ids, exchange_ids=exchange_ids)
